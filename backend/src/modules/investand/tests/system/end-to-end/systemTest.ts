...
async function runSystemTest() {
  ...
  try {
    ...
    await MarketDataRepository.saveStockData(sampleKospiData as any, 'KOSPI')
    ...
    await MarketDataRepository.saveInvestorTradingData(sampleTradingData as any)
    ...
    await MarketDataRepository.saveOptionData(sampleOptionData as any)
    ...
    await MarketDataRepository.saveInterestRateData(sampleInterestRateData)
    ...
    await MarketDataRepository.saveExchangeRateData(sampleExchangeRateData)
    ...
    try {
      ...
      const latestIndex = await FearGreedIndexRepository.findLatest()
      if (latestIndex) {
    ...
    const history = await FearGreedIndexRepository.findByDateRange(
