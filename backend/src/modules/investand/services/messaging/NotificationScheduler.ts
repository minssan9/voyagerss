...
import { MarketAnalysisService } from '@investand/services/domain/MarketAnalysisService'
...
export class NotificationScheduler {
  ...
  private async checkAndSendFearGreedAlerts(): Promise<void> {
    try {
      ...
      const { FearGreedCalculator } = await import('@investand/services/core/fearGreedCalculator')
  ...
  private async sendDartStockHoldingsReport(): Promise<void> {
    try {
      ...
      const { DartDisclosureRepository } = await import('@investand/repositories/dart/DartDisclosureRepository')
