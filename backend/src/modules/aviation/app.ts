...
// @ts-ignore
import AIProviderManager from './features/aviation-quiz-system/message-generation/aiProviders/aiProvider';
import ApplicationFactory from './ApplicationFactory';
// @ts-ignore
import MessageGenerator from './features/aviation-quiz-system/message-generation/messageGenerator';
// @ts-ignore
import CommandHandlers from './features/messaging/commandHandlers';
// @ts-ignore
import AdminServer from './admin/adminServer';

declare global {
    var aviationBot: AviationBot;
}

export class AviationBot {
    private config: any;
    private bot: any;
    private aiProvider: any;
    private aviationKnowledgeService: any;
    private messageGenerator: any;
    ...
    private async _logAviationKnowledgeStats() {
        try {
