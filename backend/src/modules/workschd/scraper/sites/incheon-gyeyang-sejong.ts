...
export class IncheonGyeyangSejongScraper extends BaseScraper {
  readonly funeralHomeName = '계양세종병원 장례식장';
  readonly funeralHomeUrl = 'https://gyeyangse.funeralhow.com';
  ...
  parse(html: string): ScrapedFuneral[] {
    ...
    $('.funeral-item, .deceased-item, table tbody tr, .obitu-list li').each((_: number, el: any) => {
