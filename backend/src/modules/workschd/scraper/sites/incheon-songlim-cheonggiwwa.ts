...
export class IncheonSonglimCheonggiwwaScraper extends BaseScraper {
  readonly funeralHomeName = '송림청기와 장례식장';
  readonly funeralHomeUrl = 'https://www.cheonggiwwa.com';
  ...
  parse(html: string): ScrapedFuneral[] {
    ...
    $('table tbody tr, .funeral-list tr, .binso-list tr').each((_: number, el: any) => {
