...
export class IncheonHallimScraper extends BaseScraper {
  readonly funeralHomeName = '한림병원 장례식장';
  readonly funeralHomeUrl = 'https://www.hallym.co.kr';
  ...
  parse(html: string): ScrapedFuneral[] {
    ...
    $('table tbody tr, .funeral-info tr, .binso-list tr').each((_: number, el: any) => {
