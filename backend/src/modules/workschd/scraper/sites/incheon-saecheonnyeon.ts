...
export class IncheonSaecheonnyeonScraper extends BaseScraper {
  readonly funeralHomeName = '새천년장례식장';
  readonly funeralHomeUrl = 'http://www.saecheonnyeon.co.kr';
  ...
  parse(html: string): ScrapedFuneral[] {
    ...
    $('table tbody tr, .funeral-list tr').each((_: number, el: any) => {
