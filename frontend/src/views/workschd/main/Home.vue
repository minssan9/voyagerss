    ...
    <div class="modern-page__header fade-in">
      <div class="row justify-center items-center q-py-xl">
        <div class="col-12 col-md-8 text-center">
          ...
          <p class="modern-text__subtitle q-mb-xl text-h6">{{ t('home.header.subtitle', '효율적인 근무 관리를 위한 스케줄 자동화 솔루션') }}
          </p>
          <div class="row q-col-gutter-md justify-center">
            <div class="col-auto">
              <q-btn class="modern-button" :label="t('home.header.button.start', '지금 시작하기')" :href="webUrl" no-caps />
            </div>
            <div class="col-auto">
              <q-btn class="modern-button modern-button--secondary" :label="t('home.header.button.learnMore', '더 알아보기')"
                :href="webUrl" no-caps />
            </div>
          </div>
        </div>
                ...
                <q-item v-for="i in 3" :key="`description${i}`" class="q-py-md">
                  <q-item-section avatar>
                    <q-avatar color="accent" text-color="white"
                      :icon="['schedule', 'notifications', 'description'][i - 1]" />
                  </q-item-section>
                  <q-item-section>
      ...
      <div class="row justify-center q-mt-xl q-py-xl">
        <div class="col-12 col-md-8 text-center">
          <div class="modern-bg__glass q-pa-xl" style="border-radius: 24px;">
            ...
            <q-btn class="modern-button" color="primary" :label="t('home.cta.button', '무료로 시작하기')" :href="webUrl"
              no-caps size="lg" />
          </div>
        </div>
      </div>
...
const baseUrl = ref(import.meta.env.VITE_WORK_SCHEDULE_URL || 'https://workschedule.com');
