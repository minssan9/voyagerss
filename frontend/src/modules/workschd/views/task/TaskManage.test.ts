...
// Mock API
vi.mock('@/modules/workschd/api/api-task', () => ({
    default: {
        fetchTasks: vi.fn(),
        createTask: vi.fn(),
        updateTask: vi.fn(),
...
// Mock TaskDialog
vi.mock('@/modules/workschd/views/task/dialog/TaskDialog.vue', () => ({
    default: {
        name: 'TaskDialog',
...
vi.mock('@/modules/workschd/views/task/grid/TaskEmployeeGrid.vue', () => ({
    default: {
...
vi.mock('@/modules/workschd/store/store_team', () => ({
    useTeamStore: () => ({
