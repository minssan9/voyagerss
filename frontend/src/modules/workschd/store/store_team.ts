...
import { TeamDTO as Team, JoinRequest, TeamMember, TeamForm } from '@/modules/workschd/api/api-team';
import apiTeam from '@/modules/workschd/api/api-team';
import { Shop } from '@/modules/workschd/api/api-team-shop';
import apiTeamShop from '@/modules/workschd/api/api-team-shop';
