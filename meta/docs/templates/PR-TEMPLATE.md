...
meta/docs/
├── setup.md
├── specs/workschd-feature-spec.md
...
- **기능 명세**: `meta/docs/specs/workschd-feature-spec.md`
- **구현 가이드**: `meta/docs/guides/workschd-implementation-guide.md`
