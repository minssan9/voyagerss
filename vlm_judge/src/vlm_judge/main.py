...
from vlm_judge.config import get_db_path, get_image_dir
from vlm_judge.repository.image_repository import ImageRepository
from vlm_judge.repository.judge_record_repository import JudgeRecordRepository
from vlm_judge.router import judge_router, web_router
from vlm_judge.service.judge_service import JudgeService
from vlm_judge.service.vlm_core import VlmCore
...
app = FastAPI(title="VLM Judge", lifespan=lifespan)
