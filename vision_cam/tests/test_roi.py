...
from vision_cam.analyzers import BrightnessAnalyzer, MotionAnalyzer
from vision_cam.analyzers.base import AnalysisResult, Detection
from vision_cam.pipeline import Pipeline
from vision_cam.roi import Zone, apply_zones, load_zones, normalize_points, save_zones
...
def test_roi_tool_capture_saves_frame(tmp_path):
    from vision_cam import roi_tool
